            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm text-blue-800">
                  <span className="font-medium">Tip:</span> Select competitors that actively display prices or promotions on their website. You&apos;ll only receive alerts when their pricing information changes.
                </p>
              </div>
            </div>
          </div>
